						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
                                ...
                                @if(can(['videoes-show' , 'videoes-create' , 'videoes-edit' , 'videoes-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "videoes") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/videoes')}}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="menu-text">{{__('cp.videoes')}}</span>
                                        </a>
                                    </li>
                                ...
                                @if(can(['albums-show' , 'albums-create' , 'albums-edit' , 'albums-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "albums") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/albums')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Cooking/Fork-spoon-knife.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            ...
                                            <span class="menu-text">{{__('cp.albums')}}</span>
                                        </a>
                                    </li>
                                ...
                                @if(can(['news-show' , 'news-create' , 'news-edit' , 'news-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "news") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/news')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Border.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            ...
                                            <span class="menu-text">{{__('cp.news')}}</span>
                                        </a>
                                    </li>
