                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse">
                            <div class="card">
                                <form class="form-horizontal form_filter" method="get" action="{{url(getLocal().'/admin/report/orders')}}">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{url(app()->getLocale().'/admin/report/orders')}}" type="submit"
...
@section('script')
    <script>
        $(document).on('click','.btn_export',function () {
            $('.form_filter').attr('action', "{{url('admin/OrdersReportForAdmin/excel/orders')}}");
            $('.form_filter').submit();
            $('.form_filter').attr('action', "{{url(getLocal().'/admin/report/orders')}}");
        })
    </script>
@endsection
