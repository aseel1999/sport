                                                ...
                                                <div class="col-lg-6 col-xl-4 mb-5">
                                                    <div class="card card-custom wave wave-animate-fast">
                                                        <div class="card-body">
                                                            ...
                                                            <span
                                                                class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$news_count}}</span>
                                                            <span
                                                                class="font-weight-bold text-muted font-size-sm">{{__('cp.news_count')}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-xl-4 mb-5">
                                                    <div class="card card-custom wave wave-animate-fast">
                                                        <div class="card-body">
                                                            ...
                                                            <span
                                                                class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{$videoes}}</span>
                                                            <span
                                                                class="font-weight-bold text-muted font-size-sm">{{__('cp.videoes')}}</span>
                                                        </div>
                                                    </div>
                                                </div>
