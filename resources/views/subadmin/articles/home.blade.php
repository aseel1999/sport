...
@section('title') {{ucwords(__('cp.articles'))}}
@endsection
@section('css')
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/provider/articles/create')}}" class="btn btn-secondary  mr-2 btn-success">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-10p"> {{ucwords(__('cp.description'))}}</th>
...
{{--                                        </td>--}}
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/provider/articles/'.$one->id.'/edit')}}"
                                               class="btn btn-sm btn-clean btn-icon" title="{{__('cp.edit')}}">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a href="{{url(getLocal().'/provider/articles/'.$one->id.'/details')}}"
                                               class="btn btn-sm btn-clean btn-icon" title="{{__('cp.details')}}">
