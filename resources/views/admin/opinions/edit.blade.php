        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form method="post" action="{{url(app()->getLocale().'/admin/opinions/'.$item->id)}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       name="name_author_{{$locale->lang}}"
                                                       {{($locale->lang == 'ar') ? 'dir=rtl' :'' }} value="{{old('name_author_'.$locale->lang,@$item->translate($locale->lang)->name_author)}}"
                                                       required/>
                                            </div>
                                        </div>
                                    @endforeach
