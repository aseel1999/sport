						...
						<div class="d-flex flex-column-fluid flex-column flex-center mt-5 mt-lg-0">
							...
							<div class="login-form login-signin">
							   ...
							   @if (count($errors) > 0)
								...
								<!--begin::Form-->
								<form class="form" novalidate="novalidate" id="kt_login_signin_form"  action="{{url(app()->getLocale().'/provider/login')}}" method="post">
								    @csrf
									...
									<div class="form-group d-flex flex-wrap justify-content-between align-items-center mt-2">
										<button id="kt_login_signin_submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3" style="background: #46065C;border-color:#46065C">{{__('cp.Sign_in')}}</button>
									</div>
								</form>
								<!--end::Form-->
							</div>
