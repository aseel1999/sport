...
@section('title') {{ucwords(__('cp.albums'))}}
@endsection
@section('css')
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/albums/create')}}" class="btn btn-secondary  mr-2 btn-success">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/albums')}}">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{url(app()->getLocale().'/admin/albums')}}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-5p"> {{ucwords(__('cp.name_album'))}}</th>
