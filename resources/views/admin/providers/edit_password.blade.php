...
@section('companyContent')
    <div class="flex-row-fluid ml-lg-8">
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form method="post" action="{{url(app()->getLocale().'/admin/providers/'.$item->id.'/edit_password')}}"
                ...
                <div class="d-flex align-items-center">
                    <a href="{{url(getLocal().'/admin/providers')}}" class="btn btn-secondary  mr-2">{{__('cp.cancel')}}</a>
